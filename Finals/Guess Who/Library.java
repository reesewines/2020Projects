...
public class Library {
    private ArrayList<Book> charactersList = new ArrayList<Book>();
  ...
  public Library()
  {
    ...
    try
    {
      Scanner sc = new Scanner(new File("starWarsCharacters.csv"));
      while (sc.hasNextLine())
      {
        ...
        characters.add(new Book(title, author, rating));
	    }
    } catch (Exception e) { System.out.println("Error reading or parsing starWarsCharacters.csv" + e); }
  }
   ...
   */
  public ArrayList<Book> charactersList()
  {
    return characters;
  }
